...
$(document).on('click', '.size', function () {
    if ($(this).hasClass("button_color")) {
        $(this).removeClass("button_color");
    }
    else {
        $(".size").removeClass("button_color");
...
// End Add cart number
// Detail
let detailMenuItemTitles = document.querySelectorAll('.detail-item-title');

        detailMenuItemTitles.forEach(menuItemTitle => {
        ...
        $(document).ready(function(){
            ...
            $('.product-color').on('click', function(){
              ...
              $('.img-product').slick('slickGoTo', slideIndex - 1);
            });
          });
    // ************************************************
        // Shopping Cart API
